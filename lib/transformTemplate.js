...
const transformTemplate = (template, options = {}) => {
    ...
    if (transformOptions.format !== 'html') {
        resultTemplate = toHtml(resultTemplate, transformOptions)
    }
    ...
    return resultTemplate
        ...
        .replace(/ng-switch=/g, '[ngSwitch]=')
        .replace(/ng-switch-when/g, '*ngSwitchCase')
        .replace(/ng-switch-default/g, '*ngSwitchDefault')
